...
<div 
  id="sidebar" 
  role="navigation"
  class="fixed top-0 left-0 h-screen w-[280px] bg-white border-r border-gray-200 transition-all duration-300 ease-in-out overflow-hidden z-[100] flex flex-col {isExpanded ? 'translate-x-0 shadow-md' : '-translate-x-full shadow-none'} {isPinned ? 'translate-x-0' : ''}"
...
>
  <div class="flex justify-between items-center px-5 py-[18px] border-b border-gray-200 bg-white">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{isPinned ? 'rotate-45 text-blue-500' : ''}">
  ...
  <div class="p-5 border-b border-gray-200 bg-white">
    <div class="flex items-center bg-gray-100 rounded-lg px-3.5 py-2.5 transition-all duration-200 focus-within:bg-white focus-within:shadow-sm focus-within:shadow-gray-200">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2.5 text-gray-500">
  ...
  <div class="flex-1 overflow-y-auto py-2 bg-white">
    <h3 class="px-5 py-2 text-xs font-medium uppercase tracking-wider text-gray-500">Recent Chats</h3>
    <div class="space-y-0.5 px-2">
      {#each recentChats as chat (chat.id)}
        <div class="flex items-center gap-3 px-3 py-3 rounded-md hover:bg-gray-100 cursor-pointer">
          <div class="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-gray-500">
